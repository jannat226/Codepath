...
# using a postorder traversal. In a postorder traversal, you explore the left subtree first, then the right subtree, 
...
# why you believe your solution has the stated time and space complexity. Assume the input tree is balanced
# when calculating time and space complexity.
...
def survey_tree(root):
    ...
    if not root.left and root.right:
        return [root.val]
    left_traversal = survey_tree(root.left)
    right_traversal = survey_tree(root.right)
